projection (cut = true) {
  translate ([0, 0, -0.1]) {
    difference () {
      ...
      translate ([0, 0, -10]) {
        union () {
          translate ([-77.59816063271012, 25.578111580583094, 175]) {
            union () {
          ...
          translate ([-86.23963125876537, -33.654865481444986, 175]) {
            union () {
              cylinder ($fn=30, h=350, r1=1.7, r2=1.7, center=true);
              translate ([0, 0, 175]) {
                sphere ($fn=30, r=1.7);
          ...
          translate ([4.382853386071069, -22.207222700756837, 175]) {
            union () {
              cylinder ($fn=30, h=350, r1=1.7, r2=1.7, center=true);
              translate ([0, 0, 175]) {
                sphere ($fn=30, r=1.7);
          ...
          translate ([5.381451425929633, 25.854291187078218, 175]) {
            union () {
              cylinder ($fn=30, h=350, r1=1.7, r2=1.7, center=true);
              translate ([0, 0, 175]) {
                sphere ($fn=30, r=1.7);
          ...
          translate ([-54.71747623856241, -64.30576057425819, 175]) {
            union () {
              cylinder ($fn=30, h=350, r1=1.7, r2=1.7, center=true);
              translate ([0, 0, 175]) {
                sphere ($fn=30, r=1.7);
