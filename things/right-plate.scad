projection (cut = true) {
  translate ([0, 0, -0.1]) {
    difference () {
      ...
      translate ([0, 0, -10]) {
        union () {
          translate ([-77.59714602631773, 26.07810682094346, 175]) {
            union () {
          ...
          translate ([-86.23557291046178, -34.65481788559235, 175]) {
            union () {
              cylinder ($fn=30, h=350, r1=1.7, r2=1.7, center=true);
              translate ([0, 0, 175]) {
                sphere ($fn=30, r=1.7);
          ...
          translate ([4.386639651879634, -23.207175104904202, 175]) {
            union () {
              cylinder ($fn=30, h=350, r1=1.7, r2=1.7, center=true);
              translate ([0, 0, 175]) {
                sphere ($fn=30, r=1.7);
          ...
          translate ([5.382398010403298, 26.35428642743858, 175]) {
            union () {
              cylinder ($fn=30, h=350, r1=1.7, r2=1.7, center=true);
              translate ([0, 0, 175]) {
                sphere ($fn=30, r=1.7);
          ...
          translate ([-54.71348546018748, -65.30571297840555, 175]) {
            union () {
              cylinder ($fn=30, h=350, r1=1.7, r2=1.7, center=true);
              translate ([0, 0, 175]) {
                sphere ($fn=30, r=1.7);
